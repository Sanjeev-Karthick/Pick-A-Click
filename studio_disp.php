                ...
                <ul class="navbar-nav ms-auto" style="margin-left: 80%;">
                    <li class="nav-item">
                        <label class="dropdown">
                            ...
                            <ul class="dd-menu">
                                <li>Welcome   <b><?php echo $username;?>! </b></li>
                                <li> <a href="booking_display.php" class="btn btn-outline-primary">  Your bookings </a></li>
                                <li class="divider"></li>
                ...
                <div class="container">
                    <div class="header-content">
                        ...
                        <div>
                            ...
                            <br />
                            <a href="booking_form.php?num=<?php echo $id ?>" class="btn btn-success btn-lg shadow" style="padding: 12px">
                                <b>BOOK NOW </b>
                            </a>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    <div class="card">
                        <div class="row">
                            ...
                            <div class="col-10">
                            <form action="studio_disp.php?num=<?php echo $id?>" method="post" >
                                <div class="comment-box ml-2">
                                    <input name="stud_id" value="<?php echo $id ?>" type="hidden"></input>
                                    <label>
                                        <h4>Rating</h4>
                                    </label><br>
                                    <div class="rating"> <input type="radio" name="rating" value="5" id="5"><label for="5">☆</label> <input type="radio" name="rating" value="4" id="4"><label for="4">☆</label> <input type="radio" name="rating" value="3" id="3"><label for="3">☆</label> <input type="radio" name="rating" value="2" id="2"><label for="2">☆</label> <input type="radio" name="rating" value="1" id="1"><label for="1">☆</label> </div>
                                    <div class="comment-area"> <textarea class="form-control" name="coment" placeholder="Add your comments..." rows="4"></textarea> </div>
                                    <div class="row">
                                        <div class="comment-btns mt-2" style="padding:10px">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="pull-left"> <button class="btn btn-success btn-sm" style="visibility:hidden">Cancel</button> </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="pull-right"> <button class="btn btn-success sends btn-lg" type="submit">Post</button> </div>
                    ...
                    ?>
                            <div class="card">
                                <div class="row">
                                    <div class="col-10">
                                        <div class="comment-box ml-2">
                                            <div class="d-flex flex-row user-info"><img class="rounded-circle" src="https://cdn5.vectorstock.com/i/1000x1000/29/19/simple-human-icon-business-design-isolated-on-vector-23042919.jpg" width="40">
                                                <div class="d-flex flex-column justify-content-start ml-2"><span class="d-block font-weight-bold name"><?php echo $cust_name ?><span class="tab"></span> <?php echo $ctime ?></span><span class="date text-black-50">Shared publicly </span></div>
